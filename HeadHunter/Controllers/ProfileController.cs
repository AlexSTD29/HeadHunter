...
namespace HeadHunter.Controllers
{
    public class ProfileController : Controller
    {
        ...
        {
            var resumes = _context.Resumes.Where(r => r.UserId == userId).OrderByDescending(r => r.RefreshDate).ToList();
        ...
        {
            var r = _context.Resumes.FirstOrDefault(r => r.Id == resume.Id);
        ...
        {
            var vacancy = _context.Vacancies.FirstOrDefault(v => v.Id == model.Id);
            
            vacancy.Name = model.Name;
            vacancy.ExpirienceTo = model.ExpirienceTo;
            vacancy.ExpirienceFrom = model.ExpirienceFrom;
